...
CREATE TABLE `buses` (
  ...
  `start_date_bus` datetime DEFAULT NULL,
  `end_date_bus` datetime DEFAULT NULL,
  PRIMARY KEY (`id_bus`)
...
CREATE TABLE `combinations` (
  ...
  `id_bus` int(11) unsigned DEFAULT NULL,
  `comb_from` text,
  `comb_to` text,
...
CREATE TABLE `places` (
  ...
  `id_comb` int(10) unsigned DEFAULT NULL,
  `status` int(10) unsigned DEFAULT '0',
  `price` varchar(45) DEFAULT NULL,
  `place_number` int(10) unsigned DEFAULT NULL,
  `buyed` int(10) unsigned DEFAULT '0',
  `first_name` text,
  `last_name` text,
...
-- Dump completed on 2018-05-10  0:25:05
